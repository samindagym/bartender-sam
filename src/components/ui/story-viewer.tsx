  ...
  return (
    <button
      ...
      className={cn(
        ...
        "focus-visible:ring-2 focus-visible:ring-brand-orange focus-visible:ring-offset-2 focus-visible:ring-offset-brand-bg rounded-lg",
        className
      )}
      aria-label={`View ${username}'s stories`}
    >
      <div className="relative w-[80px] h-[80px] md:w-[110px] md:h-[110px]">
        {/* Pulsing notification ring for unviewed stories */}
        {!allViewed && (
          <motion.div
            className="absolute inset-[-4px] rounded-full border-2 border-brand-orange/50"
            animate={{
              scale: [1, 1.1, 1],
              opacity: [0.5, 0, 0.5],
            }}
        ...
        <div className="absolute inset-[5px] rounded-full bg-brand-bg p-[2px]">
      ...
      <span className="text-xs md:text-sm font-medium text-white/80 truncate max-w-[80px] md:max-w-[110px] mt-1 text-center">
        {username}
      </span>
    </button>
  );
...
function StoryViewerModal({
  ...
  return (
    <motion.div
      className="fixed inset-0 z-[500] bg-black/95 backdrop-blur-2xl flex items-center justify-center h-[100dvh]"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
    ...
    >
      <motion.div
        ref={containerRef}
        className="relative w-full h-full max-w-xl mx-auto flex flex-col overflow-hidden md:h-[90vh] md:rounded-3xl md:border md:border-white/10 md:shadow-2xl md:shadow-black/50"
